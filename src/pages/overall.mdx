...
One day, you stumbled across a big book, with a title "". You picked it up,
and found some sentences on the preface. 

"
<Highlighter target="version" title="Version"
description="I mean, this is a incomplete webpage, and I decided to add more after deadline.
Is this allowed by SoME? Tell me if it is not.">
<span id="version">0.99</span>
</Highlighter>
...
my hand-drawn. Well, tell me if I could post those.
3. Use <Highlighter class="bare" target="mode" description="oops, you found me?">
