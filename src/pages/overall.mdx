...
This version is updated on 21th, minor fixes ported according to previous feedback.
">
<span id="version" style="text-decoration: underline;">1.0.2</span>
...
directions={ [['"A bunch of cards! The journey begins!!!"', `${import.meta.env.BASE_URL}ch1`],
...
4. The appendices, story for the unseasoned and most of the Modes are
unfinished in version 1.0.1, as well as some conversation paragraphs.
5. Have fun!
