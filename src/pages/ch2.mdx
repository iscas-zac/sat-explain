...
<Choice
  ...
  directions={[
    ...
    ["I'd skip to next chapter", `${import.meta.env.BASE_URL}ch3`],
  ]}
/>
...
Indicate the reasoning process only gives another formula as a result,
not the satisfiability
...
<Guide
directions={ [["appendix on various kind of logic", `${import.meta.env.BASE_URL}ap2`],
["next chapter", `${import.meta.env.BASE_URL}ch3`]] }
>
