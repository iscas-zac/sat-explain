...
The reasoning process has some key elements. For example, axioms are
some kinds of statements we all agree.
...
the work is enormous, yet effective. When we talk about *enumerate*,
