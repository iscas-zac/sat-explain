...
<Choice
  ...
  directions={[
    ...
    ["I'd read a story!", `${import.meta.env.BASE_URL}shortpath-story`],
  ]}
  submit = { false }
/>
...
<Guide
directions={ [["I've read enough.", `${import.meta.env.BASE_URL}afterwords`], ["Give me keywords.", `${import.meta.env.BASE_URL}shortpath-appendix`]] }
>
